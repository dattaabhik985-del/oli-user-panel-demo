...
export default function Login() {
  ...
  const emailLogin = () => {
    setErr('');
    if (email.trim().toLowerCase() !== 'demo@email.com' || pwd !== 'Demo123@') {
            ...
            <div className="mt-5 space-y-4">
              ...
              <div>
                ...
                <div className="text-right mt-1">
                  <button data-testid="forgot-password-link" className="text-[10px] text-[#EA6D27] hover:underline" onClick={() => toast.info('Demo: please use Demo123@ to login.')}>Forgot password?</button>
                </div>
              </div>
